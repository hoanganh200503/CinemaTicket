...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-I82B9T5\\SQLEXPRESS;Initial Catalog=CinemaTicketDB;Integrated Security=True;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Customer>(entity =>
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B82A23058C");

            entity.ToTable(tb => tb.HasTrigger("HashPasswordOnInsert"));

            entity.HasIndex(e => e.Email, "UQ__Customer__A9D1053434BDE753").IsUnique();
        ...
        {
            entity.HasKey(e => e.MovieId).HasName("PK__Movies__4BD2943ABE003228");
            ...
            entity.HasMany(d => d.Genres).WithMany(p => p.Movies)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MovieId", "GenreId").HasName("PK__MovieGen__BBEAC46FDFF7EBA3");
        ...
        {
            entity.HasKey(e => e.GenreId).HasName("PK__MovieGen__0385055E017FBE77");

            entity.HasIndex(e => e.GenreName, "UQ__MovieGen__BBE1C33901047751").IsUnique();
        ...
        {
            entity.HasKey(e => e.PromotionId).HasName("PK__Promotio__52C42F2F1B8496BB");
            ...
            entity.HasMany(d => d.Tickets).WithMany(p => p.Promotions)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("PromotionId", "TicketId").HasName("PK__Promotio__35D6E34D89EA6513");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__Reviews__74BC79AE0A13067A");
        ...
        {
            entity.HasKey(e => e.RoomId).HasName("PK__Rooms__32863919CB5580D0");
        ...
        {
            entity.HasKey(e => e.SeatId).HasName("PK__Seats__311713D37F32FA1F");

            entity.HasIndex(e => new { e.RoomId, e.SeatNumber }, "UQ__Seats__2C64E5A8635478B3").IsUnique();
        ...
        {
            entity.HasKey(e => e.ShowtimeId).HasName("PK__Showtime__32D31FC04C78E9EA");
        ...
        {
            entity.HasKey(e => e.TicketId).HasName("PK__Tickets__712CC627512E1F27");
        ...
        {
            entity.HasKey(e => e.TransactionId).HasName("PK__Transact__55433A4BEF6F6E4E");
        ...
        {
            entity.HasKey(e => e.TransactionTicketId).HasName("PK__Transact__9F7946F800FEFF67");
