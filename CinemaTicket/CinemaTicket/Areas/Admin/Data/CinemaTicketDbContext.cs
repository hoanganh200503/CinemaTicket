...
public partial class CinemaTicketAdminDbContext : DbContext
{
    public CinemaTicketAdminDbContext()
    {
    }

    public CinemaTicketAdminDbContext(DbContextOptions<CinemaTicketAdminDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        => optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=CinemaTicketDB;Integrated Security=True;Trust Server Certificate=True"); //Sửa lại đồng bộ với appsetings.json
#warning You Maybe need to change the connection string to match your database server
