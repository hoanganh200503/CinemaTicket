...
namespace CinemaTicket.Controllers
{
    public class ReviewManagementController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReviewId,MovieId,CustomerId,IsApproved,Rating,Comment,CreatedAt,UpdatedAt")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReviewId,MovieId,CustomerId,IsApproved,Rating,Comment,CreatedAt,UpdatedAt")] Review review)
        {
